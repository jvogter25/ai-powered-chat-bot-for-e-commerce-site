...
export default function Home() {
  ...
  return (
    <Layout>
      <Head>
        <title>AI powered chat bot for e commerce site</title>
        <meta name="description" content="AI powered chat bot for e commerce site" />
      </Head>

      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Welcome to AI powered chat bot for e commerce site
          </h1>
